...
//DIRECTORIOS FISICIOS DE LA APLICACION
...
defined('PO_PATH_APP_CONTENT') ?: define('PO_PATH_APP_CONTENT', PO_PATH_APP . DS . 'src');
defined('PO_PATH_WEBROOT') ?: define('PO_PATH_WEBROOT', PO_PATH_APP . DS . 'webroot');

defined('PO_PATH_VIEW') ?: define('PO_PATH_VIEW', PO_PATH_APP_CONTENT . DS . 'View');
